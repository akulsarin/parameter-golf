...
4. Run the experiment: `uv run train_gpt_mlx.py > logs/run.log 2>&1` (redirect everything — do NOT use tee or let output flood your context). Run `mkdir -p logs` if needed.
